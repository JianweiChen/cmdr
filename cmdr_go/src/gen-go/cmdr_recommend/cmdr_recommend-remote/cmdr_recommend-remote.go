...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  RecommendResponse feed(RecommendRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "feed":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Feed requires 1 args")
      flag.Usage()
    }
    arg5 := flag.Arg(1)
    ...
    argvalue0 := cmdr_recommend.NewRecommendRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.Feed(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
