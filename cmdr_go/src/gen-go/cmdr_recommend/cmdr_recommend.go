...
type Resource struct {
  ...
  Himg *string `thrift:"himg,4" db:"himg" json:"himg,omitempty"`
  Source *string `thrift:"source,5" db:"source" json:"source,omitempty"`
  Digg *int32 `thrift:"digg,6" db:"digg" json:"digg,omitempty"`
  Bury *int32 `thrift:"bury,7" db:"bury" json:"bury,omitempty"`
  Impr *int32 `thrift:"impr,8" db:"impr" json:"impr,omitempty"`
  Detail *int32 `thrift:"detail,9" db:"detail" json:"detail,omitempty"`
  Download *int32 `thrift:"download,10" db:"download" json:"download,omitempty"`
}
...
var Resource_Himg_DEFAULT string
func (p *Resource) GetHimg() string {
  if !p.IsSetHimg() {
    return Resource_Himg_DEFAULT
  }
return *p.Himg
}
var Resource_Source_DEFAULT string
func (p *Resource) GetSource() string {
  if !p.IsSetSource() {
    return Resource_Source_DEFAULT
  }
return *p.Source
}
var Resource_Digg_DEFAULT int32
func (p *Resource) GetDigg() int32 {
  if !p.IsSetDigg() {
    return Resource_Digg_DEFAULT
  }
return *p.Digg
}
var Resource_Bury_DEFAULT int32
func (p *Resource) GetBury() int32 {
  if !p.IsSetBury() {
    return Resource_Bury_DEFAULT
  }
return *p.Bury
}
var Resource_Impr_DEFAULT int32
func (p *Resource) GetImpr() int32 {
  if !p.IsSetImpr() {
    return Resource_Impr_DEFAULT
  }
return *p.Impr
}
var Resource_Detail_DEFAULT int32
func (p *Resource) GetDetail() int32 {
  if !p.IsSetDetail() {
    return Resource_Detail_DEFAULT
  }
return *p.Detail
}
var Resource_Download_DEFAULT int32
func (p *Resource) GetDownload() int32 {
  if !p.IsSetDownload() {
    return Resource_Download_DEFAULT
  }
return *p.Download
}
...
func (p *Resource) IsSetHimg() bool {
  return p.Himg != nil
}

func (p *Resource) IsSetSource() bool {
  return p.Source != nil
}

func (p *Resource) IsSetDigg() bool {
  return p.Digg != nil
}

func (p *Resource) IsSetBury() bool {
  return p.Bury != nil
}

func (p *Resource) IsSetImpr() bool {
  return p.Impr != nil
}

func (p *Resource) IsSetDetail() bool {
  return p.Detail != nil
}

func (p *Resource) IsSetDownload() bool {
...
func (p *Resource) writeField4(oprot thrift.TProtocol) (err error) {
  if p.IsSetHimg() {
    if err := oprot.WriteFieldBegin("himg", thrift.STRING, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:himg: ", p), err) }
    if err := oprot.WriteString(string(*p.Himg)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.himg (4) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 4:himg: ", p), err) }
  }
  return err
}
...
func (p *Resource) writeField6(oprot thrift.TProtocol) (err error) {
  if p.IsSetDigg() {
    if err := oprot.WriteFieldBegin("digg", thrift.I32, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:digg: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Digg)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.digg (6) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 6:digg: ", p), err) }
  }
  return err
}
...
func (p *Resource) writeField7(oprot thrift.TProtocol) (err error) {
  if p.IsSetBury() {
    if err := oprot.WriteFieldBegin("bury", thrift.I32, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:bury: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Bury)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.bury (7) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 7:bury: ", p), err) }
  }
  return err
}
...
func (p *Resource) writeField8(oprot thrift.TProtocol) (err error) {
  if p.IsSetImpr() {
    if err := oprot.WriteFieldBegin("impr", thrift.I32, 8); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:impr: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Impr)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.impr (8) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 8:impr: ", p), err) }
  }
  return err
}
...
func (p *Resource) writeField9(oprot thrift.TProtocol) (err error) {
  if p.IsSetDetail() {
    if err := oprot.WriteFieldBegin("detail", thrift.I32, 9); err != nil {
...
func (p *Resource) writeField10(oprot thrift.TProtocol) (err error) {
  if p.IsSetDownload() {
    if err := oprot.WriteFieldBegin("download", thrift.I32, 10); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 10:download: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Download)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.download (10) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 10:download: ", p), err) }
  }
  return err
}
